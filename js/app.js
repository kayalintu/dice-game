...
document.querySelector('.btn-roll').addEventListener('click', function () {
    if (gamePlaying) {
        // 1. Random number
        var dice1 = Math.floor(Math.random() * 6) + 1; // Variables in scoped
        var dice2 = Math.floor(Math.random() * 6) + 1; // Variables in scoped
        ...
        if (dice1 !== 1 && dice2 !== 1) {
            // Add score
            roundScore += dice1 + dice2; // It's equal roundScore + dice;
